...
Choose your portfolio type. If you want to set up an enhanced backup with recovery time, you can select the "*Build your own*" option and opt for the default scheme. The operation will be much the same, except that you won't need to retain the hardware wallet recovery phrase.
