...
- Обратите внимание на странную пунктуацию, такую как \*\* , которая может представлять собой плохую рендеринг жирного символа **. Всегда проверяйте оригинальный английский текст, чтобы увидеть, должен ли там быть жирный текст. Вы можете найти больше информации о языке markdown [здесь](https://www.markdownguide.org/basic-syntax/).
