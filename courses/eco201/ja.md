...
このコースはThéo Mogenetによって提供されており、主流のケインズ経済学とは根本的に異なる経済思想の学派を発見することができます。これまで、金融管理や経済政策は主に中央銀行の管轄下にあると教えられ、通貨の発行や公共支出が経済成長を促進するという考えが一般的でした。しかし、より一貫した代替的なアプローチが存在します。それが**オーストリア学派経済学**です。

カール・メンガー、ルートヴィヒ・フォン・ミーゼス、フリードリヒ・ハイエクなどの著名な著者による二世紀以上にわたる研究、哲学的思索、著作に基づき、この学派は異なる視点を採用し、個人と人間の合理性に基づく分散的な経済観を重視します。

経済学は実際には非常に社会的で複雑な分野であり、多くの独立した主体が自由に相互作用することで一貫した全体を形成します。この動的なシステムを理解するために、オーストリア学派は人間の論理、社会学、市場プロセスの研究に基づく質的な分析を重視し、硬直した数学的方程式よりも重視します。

このコースでは、この学派の基本的な原則を探求していきます。Théo Mogenetは、この経済的アプローチに熱心で、Bitcoinの世界に特に適用されるこれらのアイデアを示しながら、オーストリア学派経済学の重要な概念を教育的に案内してくれます。

**セクション1：ECONへの入門**  
まず、オーストリア学派経済学の一般的な紹介を行い、その歴史的起源と思想の基礎を探求します。このセクションでは、貨幣、信用、銀行、中央銀行といった重要な概念も取り上げます。特に、通貨介入に対する批判において、これらの機関がオーストリア学派の思考で重要な役割を果たしている理由を理解することができます。

**セクション2：理論的基礎**  
このセクションでは、オーストリア学派経済学の基本的な概念、例えば「主観的価値理論」について掘り下げます。この理論は、商品の価値が客観的なものではなく、各個人によって認識される効用に依存することを説明します。また、貨幣が社会現象として自然に生じる仕組みや、自由市場理論の中核を成す時間選好、利子、資本の概念についても学ぶことができます。

**セクション3：オーストリア学派経済学の視点**  
ここでは、オーストリア学派の理論の実際の応用について探求します。特に、貨幣操作によって人工的な景気拡大が生じ、その後に景気後退が続く仕組みを説明する「オーストリア景気循環理論」について詳しく学びます。また、社会主義体制下での経済計算が不可能である理由や、人間の行動の研究（プラキセオロジー）に基づくオーストリア学派の方法論が、経済現象を理解するための独自で一貫したアプローチを提供することについても取り上げます。

このコースは経済学と哲学の融合であり、Théoと私（Rogzy）とのオープンな議論によって導かれています。Théo Mogenetにこのコースを作成していただいたことに心から感謝します。このコンテンツの開発は非常に楽しいもので、すべての人にアクセスできるように設計されています。このコースは重要な入門編であり、今後のより高度な経済モジュールの基礎を築きます。

現在の経済を理解する鍵が何世紀も前の理論にあるとしたら？一緒に発見しましょう！
