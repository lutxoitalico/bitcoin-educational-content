...
objectives: 
  ...
  - Tener una idea concreta de cómo aceptar pagos con bitcoin en la práctica
...
A lo largo de esta guía, aprenderá a entender Bitcoin como una red monetaria global, universal y nativa de Internet. Con sus características fundamentales únicas, **Bitcoin proporciona mejoras significativas sobre las redes monetarias tradicionales**. Descubrirá por qué y cómo aprovechar Bitcoin para casos de uso financiero clásicos como el almacenamiento de capital y los sistemas de pago. Además, esta guía cubrirá la adquisición y tenencia de Bitcoin, incluyendo los requisitos contables y fiscales asociados, así como la implementación de soluciones de pagos con Bitcoin simples o a gran escala.
...
## Incorpore Bitcoin a su negocio

<chapterId>1be42be9-4080-49f5-b5b2-6b531dd55f5f</chapterId>

Inicie el viaje de su empresa en la red Bitcoin con este completo curso de formación - una puerta de entrada a la comprensión de cómo Bitcoin y la Lightning Network pueden revolucionar las operaciones comerciales tradicionales. Este curso está diseñado para negocios minoristas, empresarios, gerentes y responsables de la toma de decisiones corporativas que deseen explorar las capacidades prácticas de Bitcoin como una red monetaria global, nativa de Internet y un medio robusto de intercambio de valor.

A lo largo del curso, se le presentarán los principios fundamentales que hacen que Bitcoin y la Lightning Network sean claramente transformadores. Aprenderá cómo estas tecnologías ofrecen un espectro de casos de uso, desde el almacenamiento de capital digital a pagos rápidos, económicos y escalables, y cómo proporcionan mejoras importantes sobre la moneda tradicional y los sistemas de pago. El curso BIZ101 conecta la teoría económica con las aplicaciones del mundo real, aclarando cómo la descentralización puede reducir la dependencia de los intermediarios y superar las limitaciones inherentes a los sistemas tradicionales.

El curso comienza con un examen detallado de las monedas convencionales y los mecanismos de pago, sentando las bases mediante la exploración de cómo la moneda funciona como una red para permitir el comercio, el ahorro y la especialización económica. Posteriormente, profundizaremos en la tecnología que hay detrás de Bitcoin y en las innovaciones introducidas por la Lightning Network, revelando su papel a la hora de facilitar transacciones fluidas, seguras y casi instantáneas que pueden servir a empresas de todos los tamaños. A continuación, nos sumergiremos en las secciones prácticas de este curso, comenzando con una parte sobre la tenencia de bitcoins en caja, como liquidez de tesorería, seguida de una parte final sobre la aceptación de bitcoin como medio de pago.
...
En cuanto a tecnología y herramientas, soluciones como **BTC Pay Server** suelen formar el núcleo de una configuración profesional. BTC Pay Server es una plataforma de código abierto que puede desplegarse en las instalaciones o mediante alojamiento en la nube y que ofrece amplias opciones de integración para sitios web y plataformas de comercio electrónico. Al ejecutar su propia instancia, las empresas conservan un alto grado de control sobre todos los aspectos del flujo de pagos, desde las páginas de pago generadas automáticamente hasta las notificaciones que activan procesos internos una vez que se confirma un pago.

![BIZ101-profiles](assets/en/27.webp)

Además, herramientas como [Zaprite](https://zaprite.com/) o [Musqet](https://musqet.tech/) pueden refinar aún más la experiencia de pago, permitiendo una personalización más granular (desde opciones de marca hasta sofisticadas capacidades de generación de informes). Los que prefieren un entorno de venta online todo en uno pueden decantarse por [Be-BOP](https://be-bop.io/), una solución de tienda electrónica creada para facilitar los pagos con Bitcoin sin sacrificar la facilidad de uso.

![BIZ101-profiles](assets/en/28.webp)

Implantar estas tecnologías en un entorno profesional significa prestar mucha atención a la **complejidad operativa**. Los flujos de trabajo de facturación automatizados, las pantallas multidivisa y la sincronización con los sistemas de inventario existentes son características distintivas de una plataforma bien integrada. La capacidad de exportar con precisión los datos de las transacciones (ya sea como archivos CSV, llamadas directas a la API o formatos personalizados) ayuda a las empresas a conciliar las ventas de bitcoins con otros flujos de ingresos de manera eficiente.

La seguridad y la gestión de roles constituyen otra consideración fundamental para los usuarios profesionales. A medida que se acumulan las transacciones diarias de Bitcoin, controlar el acceso a las funciones administrativas se convierte en una medida esencial de mitigación de riesgos. En muchas soluciones, los administradores pueden asignar distintos niveles de permiso (quizás restringiendo a algunos empleados la visualización del historial de transacciones y la generación de facturas, mientras que a otros se les concede autoridad para gestionar el inventario o configurar los ajustes de todo el sistema...). Esta estructura jerárquica no sólo protege los datos confidenciales, sino que también agiliza las operaciones al aclarar qué miembros del personal son responsables de cada segmento de la infraestructura de pagos.

En cuanto a ejemplos reales, pensemos en una tienda de comercio electrónico de tamaño medio especializada en accesorios tecnológicos. La empresa podría integrar BTC Pay Server en su tienda online, generando automáticamente direcciones de pago Bitcoin durante la compra. Los clientes completan sus compras escaneando una dirección Lightning u on-chain, y la plataforma de la tienda confirma instantáneamente el pago. Al mismo tiempo, un sistema interno actualiza el estado del pedido y activa las notificaciones de envío. Gracias a las funciones avanzadas de generación de informes, el equipo financiero puede revisar fácilmente las ventas diarias de Bitcoin, exportar un libro mayor consolidado para auditoría y realizar un seguimiento del valor de cualquier participación en BTC que la empresa decida conservar.

![BIZ101-profiles](assets/en/29.webp)

*[Crédito: Tienda Bitcoin Bazar en París, Francia](https://bitcoinbazar.fr/)*
...
El perfil Empresario se sitúa en la cúspide de las implementaciones de pagos con Bitcoin, diseñado específicamente para grandes empresas, grandes mercados y negocios establecidos que exigen soluciones totalmente personalizadas. A diferencia de las implementaciones a pequeña o mediana escala, las operaciones de nivel empresarial integran los pagos con Bitcoin en un amplio abanico de flujos de trabajo y sistemas, desde dispositivos de punto de venta in situ hasta escaparates de comercio electrónico, plataformas de contabilidad administrativas y sofisticados marcos ERP. (Planificaores de Recursos Empresariales)

A esta escala, el objetivo global no es simplemente aceptar Bitcoin, sino hacerlo de una manera que esté completamente **alineada con los procesos centrales de la organización**. Esta alineación puede requerir el desarrollo de software especializado, tanto si la solución es totalmente a medida como si está orquestada a través de una infraestructura basada en SaaS respaldada por terceros *Proveedores de Servicios de Lightning* (LSP). Estos LSP pueden gestionar grandes volúmenes de transacciones y configuraciones de red complejas que superan la capacidad de las herramientas más convencionales. Por tanto, la arquitectura resultante incorpora una amplia gama de consideraciones técnicas y empresariales, desde integraciones basadas en API hasta funciones avanzadas de gestión de tesorería.
...
En el frente contable, las transacciones de alta frecuencia exigen **exportaciones totalmente personalizadas** y a veces sincronización en tiempo real con el software financiero corporativo. Las grandes empresas pueden depender de soluciones de planificación de recursos empresariales (ERP) como SAP u Oracle, que, a su vez, deben interactuar sin problemas con los datos de pago de Bitcoin. Para facilitar esto, las API de la plataforma elegida deben ser sofisticadas y flexibles, dando a los equipos de tecnología informática la libertad de crear paneles de informes personalizados, implementar procesos de conciliación automatizados y generar resúmenes financieros diarios o incluso cada hora.

Un escenario empresarial típico podría ser el de un gran mercado de comercio electrónico que recibe miles de transacciones cada día. Más allá de la mera inclusión de Bitcoin como opción de pago, este mercado puede adaptar todos los aspectos de la experiencia del usuario, desde cómo aparece el flujo de pago de Bitcoin en el sitio web de cara al cliente hasta cómo se gestionan los reembolsos, las devoluciones de cargos o las resoluciones de disputas en el back-end. Un equipo de desarrollo especializado, en colaboración con los departamentos financiero y jurídico, supervisaría el mantenimiento continuo, los parches de seguridad y las actualizaciones de cumplimiento. Si la empresa decidiera retener una parte de sus ingresos en Bitcoin, un sistema de tesorería interno realizaría un seguimiento de las tenencias de bitcoins de la empresa junto con las reservas de divisas tradicionales.

Para garantizar un despliegue seguro y sin problemas a nivel empresarial, la mayoría de las organizaciones contratan a proveedores de servicios especializados o a equipos de desarrollo internos con experiencia en integraciones de Bitcoin y Lightning Network. El proceso suele comenzar con una evaluación en profundidad de las necesidades (que abarca la infraestructura técnica, los requisitos de cumplimiento y el recorrido deseado por el cliente), seguida del diseño de una arquitectura que pueda gestionar un alto volumen de rendimiento. Dependiendo del alcance del proyecto, puede contar con un equipo multidisciplinar compuesto por controladores financieros, analistas de seguridad e ingenieros de software. Alternativamente, un número cada vez mayor de empresas de consultoría especializadas pueden guiarle desde la conceptualización inicial hasta el despliegue final, ayudándole con tareas como la evaluación de soluciones alojadas en SaaS, la configuración de *Proveedores de Servicios de Lightning* y la personalización de interfaces front-end. Al asociarse con expertos en la materia, las empresas pueden mitigar los riesgos asociados a la implantación de pagos a gran escala y conseguir una solución que no sólo sea sólida y conforme, sino también lo bastante flexible para adaptarse al crecimiento futuro.

## Soluciones de pago con Bitcoin: Opciones y tendencias
...
### ¿Busca una solución para crear una tienda y aceptar pagos tradicionales y con Bitcoin?
...
- **Soluciones sencillas:** Como alternativa, puede utilizar plataformas como Accessing.app para hacerlo usted mismo. Las principales ventajas son:
    ...
    - Procesamiento de pagos en Fiat (por ejemplo, euros, dólares) a través de su propia cuenta de Stripe.
    - Procesamiento de pagos en Bitcoin a través de su propia cuenta SwissBitcoinPay.

### ¿Cómo avanza la adopción de los pagos Lightning?

Aunque la Lightning Network ofrece una eficiencia superior y unas comisiones más bajas, su adopción está aún en sus primeras fases. En lugar de centrarse en las limitaciones actuales, merece la pena recordar cómo se desarrollaron las transformaciones históricas de las infraestructuras:
...
Bitcoin y la Lightning Network están completando la **revolución de los monederos digitales**. Los nuevos servicios web permiten ahora **transacciones sin necesidad de crear una cuenta**: ¡su monedero se convierte en su identidad! Con protocolos como **Nostr Wallet Connect (NWC)** y **LN-URL-AUTH**, los monederos pueden autenticar sin problemas a los usuarios y permitir transacciones sin cuentas tradicionales. Atrás quedaron los días de fatiga de cuentas para simples compras o suscripciones. Ya no es necesario facilitar información personal o de pago que podría acabar siendo pirateada y a la venta en la web oscura, como nos recuerdan con demasiada frecuencia los últimos acontecimientos.

![BIZ101](assets/en/10.webp)

Los comerciantes del mañana adoptarán esta innovación y ofrecerán a los clientes una experiencia más segura y fluida (con un solo clic) que también respete su privacidad.

# Contabilidad Bitcoin

<partId>d49d7595-a189-4e2b-bd60-c19e8e717aa2</partId>

## Principios esenciales del bitcoin contable en la empresa

<chapterId>84063061-ffdb-4b1f-b20b-588ffb146877</chapterId>

El siguiente contenido tiene únicamente fines educativos y no debe considerarse asesoramiento financiero o contable. Se recomienda encarecidamente a empresas y particulares que consulten a un contable cualificado o a un experto legal familiarizado con la normativa sobre criptomonedas de su jurisdicción específica antes de emprender cualquier acción.

### Conceptos clave de la contabilidad de Bitcoin

**Toda transacción con Bitcoin debe registrarse y puede dar lugar a un hecho imponible**

A nivel mundial, Bitcoin se clasifica a menudo no como una moneda, sino como un activo digital. Esta distinción afecta significativamente a cómo se contabiliza Bitcoin en las empresas, influyendo en las obligaciones fiscales, los informes financieros y los requisitos de cumplimiento. Las empresas que aceptan Bitcoin como método de pago o lo utilizan como herramienta de tesorería deben comprender estos matices normativos.

La **consecuencia más importante** a tener en cuenta es que, en la mayoría de las jurisdicciones, ganar, vender, comerciar o utilizar Bitcoin para realizar compras, suele crear **un hecho imponible** y las ganancias están sujetas al impuesto sobre plusvalías.
...
La contabilidad de las empresas que poseen Bitcoin es algo engorrosa porque cada transacción debe ser meticulosamente rastreada para calcular los beneficios o pérdidas realizados o no realizados. Por cada venta que realice aceptando Bitcoin como forma de pago, o cada vez que compre o venda Bitcoin, debe registrar:


- la hora específica
- el precio de venta (en moneda fiduciaria)
- el precio de coste del Bitcoin (el precio al que se adquirió inicialmente el Bitcoin).

Esto le permitirá más adelante poder calcular la diferencia para determinar el beneficio o la pérdida.
...
**¿Cómo funcionaría si Bitcoin fuera una moneda?**
...
**Ventaja clave si Bitcoin fuera reconocido como moneda:**


- La empresa sólo tiene que ajustar el equivalente fiat de sus tenencias de Bitcoin periódicamente (por ejemplo, para los informes mensuales o anuales), al igual que para los euros, yenes u otras divisas que posea.
- Esto elimina la necesidad de realizar un seguimiento de los costes a nivel de transacción y simplifica la contabilidad, especialmente para las empresas con transacciones Bitcoin frecuentes.

Este enfoque simplificaría enormemente la contabilidad de Bitcoin, reduciría las cargas administrativas y se alinearía con el tratamiento de otras monedas, suponiendo que Bitcoin fuera plenamente reconocido como tal en términos legales y regulatorios. Aún no hemos llegado a ese punto.

### Distinciones entre la contabilidad individual y la contabilidad corporativa de Bitcoin

El tratamiento legal y contable de Bitcoin difiere significativamente entre particulares y empresas. Para las personas físicas, las ganancias de las transacciones con Bitcoin pueden estar sujetas al impuesto sobre la renta, a menudo a un tipo más alto. Por el contrario, las empresas pueden beneficiarse de tipos impositivos potencialmente más bajos, pero deben cumplir normas contables más estrictas.
...
El reconocimiento legal y el tratamiento de Bitcoin varían según la jurisdicción. Algunos países, como El Salvador, han reconocido el Bitcoin como moneda de curso legal, lo que simplifica su uso en las transacciones pero complica la información financiera internacional. Otros tratan Bitcoin como un activo digital sujeto a normas fiscales y contables específicas.
...
### Retos de la evolución normativa
...
### Clasificación de Bitcoin en los estados financieros
...
- Las actividades activas de negociación o relacionadas con los pagos requieren un seguimiento constante de las ganancias y pérdidas realizadas y no realizadas.
...
### Contabilidad de las transacciones en el comercio minorista y electrónico

Los comercios deben registrar en cada transacción el tipo de cambio de Bitcoin a fiat. Por ejemplo, en muchos países, los comercios utilizan el tipo de cambio en el momento de la venta para calcular el IVA.

Las empresas deben asegurarse de que las herramientas de **pago** que utilizan les permiten:


- generar una factura con el importe fiat local (euros, dólares, libras), ese IVA u otros impuestos locales, el equivalente en bitcoin, la fecha y hora, el tipo de cambio de bitcoin y la fuente de cambio, etc
- exportar todos los recibos de pago, como mínimo en formato .csv, con toda la información anterior, de forma que el contable pueda procesarlos fácilmente
- lo ideal es disponer de un registro que conserve el valor actualizado de la base de coste para el Bitcoin actual mantenido en tesorería
...
Cuando una empresa decide integrar Bitcoin en su contabilidad, diversas herramientas y programas informáticos especializados simplifican la recogida y el tratamiento de los datos. Entre las soluciones más conocidas se encuentran [CoinTracker](https://www.cointracker.io/), [Waltio](https://www.waltio.com/), [Cryptio](https://cryptio.co/), [Koinly](https://koinly.io/), [TokenTax](https://tokentax.co/) y [ZenLedger](https://zenledger.io/). Estas plataformas se centran principalmente en cuatro aspectos:


- recogida automática de datos;
- conversión de estos datos a formatos compatibles con programas de contabilidad más generales (QuickBooks, Xero, ERP);
- cálculo de las obligaciones fiscales;
- categorización de las transacciones.

Suelen ser un sabio complemento para grandes organizaciones con múltiples monederos y activos en varias plataformas o bolsas.

![BIZ101](assets/en/31.webp)

Sin embargo, un simple archivo `.csv` que contenga el historial de transacciones suele ser suficiente para la mayoría de las pequeñas empresas. El objetivo es documentar, para cada pago, la fecha, el importe, el contravalor en euros/dólares y las direcciones Bitcoin correspondientes. La gran mayoría de soluciones de pago Bitcoin (BTC Pay Server, Swiss Bitcoin Pay, etc.) o plataformas de intercambio (Bitfinex, Kraken, Coinbase, etc.) ya ofrecen un mecanismo para exportar historiales de transacciones. Al proporcionar este archivo a un contable, es posible agilizar la entrada de datos y distinguir claramente los flujos entrantes y salientes relacionados con Bitcoin.
...
### Caso práctico 1: Tienda minorista que convierte pagos de Bitcoin a euros

**Escenario**: Una pequeña panadería acepta Bitcoin como método de pago, pero convierte inmediatamente todos los Bitcoin recibidos en euros para evitar la exposición a la volatilidad de la criptodivisa.
...
**Escenario**: La misma panadería opta por retener el 50% de los pagos en Bitcoin como activo de tesorería, mientras convierte el otro 50% en euros.
...
- **Transacción del cliente**: El cliente compra pasteles por 50 euros.
    ...
    - Conversión (50%): 25 euros de Bitcoin = 0,000625 Bitcoin = 62,500 Satoshis.
        ...
        - Neto percibido en euros: 25 euros - 0,375 euros = 24,625 euros.
    - Retenido en Bitcoin (50%): 62.500 Satoshis = 0,000625 Bitcoin.
...
### Caso práctico 3: Servicio profesional que retiene Bitcoin para inversiones a largo plazo

**Escenario**: Un diseñador gráfico autónomo acepta Bitcoin como pago y retiene todos los Bitcoin recibidos como inversión a largo plazo.
...
- Registre los ingresos (3.000 euros) en el momento del servicio.
- Bitcoin retuvo (0,1) valorados en 3.500 euros en el balance.
- Las ganancias no realizadas se contabilizan, pero no se incluyen en la cuenta de pérdidas y ganancias.

### Caso 4: Un empresario vende el 50% de Bitcoin tras una subida de precio

**Escenario**: El propietario de un negocio realiza tres compras de Bitcoin durante el año, mantiene el Bitcoin como activo y vende el 50% tras una subida significativa del precio.
...
- **Venta del 50% de Bitcoin**:
    ...
    - Base de costes (media ponderada):
        - Coste total: 2.000 euros + 3.000 euros + 5.000 euros = 10.000 euros.
        - Precio medio ponderado: 10.000 euros / 0,3867 Bitcoin = 25.850 euros/BTC.
        - Coste del Bitcoin vendido: 0,19335 Bitcoin × 25.850 euros = 4.999 euros.
    - Ganancia realizada: 7.734 euros - 4.999 euros = 2.735 euros.
...
- Registre el producto de la venta (7.734 euros) como ingreso.
- Deduzca el coste del Bitcoin vendido (4.999 euros) para calcular la ganancia realizada.
