...
このコースの目的は、フィアット通貨システムにおけるハイパーインフレーションの根本的な原因、メカニズム、および結果を理解することです。具体的な例と歴史的な分析を通じて、ハイパーインフレーションの前に繰り返し現れるパターンを認識し、それから身を守るための対策を特定する方法を学びます。

**セクション 2：インフレーションとは何か？**  
本題に入る前に、基本に戻りましょう：インフレーションとは何か？このセクションでは、インフレーションの通貨的な起源、存在するさまざまな種類のインフレーション、そしてそれらがどのようにより広い経済的な動態に組み込まれるかを紹介します。これは、通常のインフレーションがどのようにしてハイパーインフレーションに発展するかを理解するための不可欠なステップです。

**セクション 3：ハイパーインフレーションとは何か？**  
このセクションでは、ハイパーインフレーションの正確な定義と、ヴァイマル共和国時代のドイツやジンバブエなどの重要な歴史的エピソードを学びます。それらの共通点、違い、そして現代の類似点を分析します。また、南米における通貨の再評価の繰り返しなど、あまり知られていないケースや、いくつかの国で観察された危機脱出の道も紹介します。

**セクション 4：どのようにしてここに至ったのか？**  
このパートでは、「第二の層」の通貨システムの発展と中央銀行の役割を通じて、ハイパーインフレーションを可能にする構造的メカニズムを理解することを目的としています。さらなる理解を深めるために、追加のリソースや参考文献も提供されます。

もしかすると、通貨の歴史は今私たちの目の前で繰り返されているのかもしれません。次の章でご自身の目で確かめてください！
