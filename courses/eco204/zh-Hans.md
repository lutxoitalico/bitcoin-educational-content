...
本课程的目标是帮助您了解在法定货币体系下，恶性通货膨胀的深层原因、机制和后果。通过具体的例子和历史分析，您将学习识别出现在恶性通货膨胀时期之前的反复出现的模式，并找到应对的方法来保护自己。

**第二节：什么是通货膨胀？**  
在深入探讨主题之前，我们将回到基础：什么是通货膨胀？本节将介绍通货膨胀的货币起源、不同类型的通货膨胀，以及它们如何融入更广泛的经济动态中。这是理解普通通货膨胀如何演变为恶性通货膨胀的关键一步。

**第三节：什么是恶性通货膨胀？**  
在本节中，您将研究恶性通货膨胀的精确定义以及多个重要的历史案例，包括魏玛德国和津巴布韦。我们将分析它们的共同点、差异以及现代的相似之处。您还将了解一些不太知名的案例，例如拉丁美洲的连续货币重估，以及一些国家摆脱危机的途径。

**第四节：我们是如何走到这一步的？**  
本节旨在理解使恶性通货膨胀成为可能的结构性机制，特别是通过“第二层”货币系统的发展以及中央银行的作用。将提供更多的资源和建议的阅读材料以供进一步探索。

如果货币历史正在我们眼前重演呢？在接下来的章节中，请自行判断吧！
